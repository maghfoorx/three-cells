                ...
                <div className="grid md:grid-cols-2 gap-6">
                    {posts.map((post) => (
                        <Link
                            key={post.slug}
                            to={`/blog/${post.slug}`}
                            className="group flex flex-col p-8 border border-gray-200 rounded-md hover:border-gray-300 hover:shadow-sm transition-all duration-300 bg-white"
                            viewTransition
                        >
                            <div className="text-2xl font-bold text-gray-900 mb-3 group-hover:text-black tracking-tight">
                                {post.title}
                            </div>
